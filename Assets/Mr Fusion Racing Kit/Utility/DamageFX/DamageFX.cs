...
[AddComponentMenu("Virtual Driver/DamageFX/DamageFX Manager")]
public class DamageFX : MonoBehaviour
{
	...
	private void InitParticles()
	{
		...
		if (ParticleEffects.BrokenEngineSmoke != null)
		{
			...
			{
				Debug.LogWarning("DamageFX Error : BrokenEngineSmoke particle assigned but \"_EngineSmokePoint\" not found! Please check your vehicle configuration.");
			}
		}
	}
	...
	{
		GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(Mesh.gameObject, Mesh.transform.position, Mesh.transform.rotation);
