...
public class RCC_PhotonDemo : Photon.Pun.MonoBehaviourPunCallbacks {
    ...
    public void Spawn() {
        ...
        RCC_CarControllerV4 newVehicle;
        ...
        newVehicle = PhotonNetwork.Instantiate("Photon Vehicles/" + RCC_PhotonDemoVehicles.Instance.vehicles[selectedCarIndex].name, lastKnownPos + (Vector3.up), lastKnownRot, 0).GetComponent<RCC_CarControllerV4>();
